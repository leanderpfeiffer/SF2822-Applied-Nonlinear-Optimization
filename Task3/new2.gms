...
cons2(t) .. dx2(t) =e= ((x3(t)**2)/x1(t) - (1/x1(t)**2) + d1*dm(t)/p*sin(u(t))/(m(t)))*h;
cons3(t) .. dx3(t) =e= (-d3**2*x2(t)*x3(t)/x1(t) + d2*dm(t)/p*cos(u(t))/(m(t)))*h;
...
solve new2 using nlp maximizing z;
